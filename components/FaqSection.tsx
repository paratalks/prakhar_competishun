        ...
        <div className="gradientBorder w-full rounded-[2rem] overflow-hidden">
          <div className="flex flex-col md:flex-row gap-5 justify-between bg-[#220D00] rounded-[2rem] text-white p-6">
                    ...
                    <button
                      ...
                      className={`${
                        index === currentlyChoosenQuestion
                          ...
                          : "bg-white text-black"
                      } rounded-xl w-full py-3 px-4 text-left flex justify-between items-center transition-all duration-300`}
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-y-2">
              ...
              <div className="w-full h-full border bg-primary shadow-[5px_5px_0px_0px_rgba(255,255,255)] p-8 rounded-[2rem]">
                <p className="mb-6 text-xl leading-relaxed">
                  {Faqs[currentlyChoosenQuestion].answer}
                </p>
              </div>
              <a href="https://rzp.io/rzp/YfK1Axui" className={"w-full h-fit"}>
                <button className="bg-secondary mt-2 mb-5 w-full text-white hover:shadow-none shadow-[5px_5px_0px_0px_rgba(255,255,255)]  transition-all duration-200 font-bold py-4 px-6 rounded-full relative">
                  <motion.img
